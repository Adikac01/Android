...
class CartFragment: Fragment(), CartClickListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val combinedPrice = calcCost()
        binding.buyButton.setOnClickListener {
            cartViewModel.clearCart()
            PaymentFragment(combinedPrice).show(parentFragmentManager, "paymentFragmentTag")
    ...
    private fun calcCost():Double{
        val combinedPrice = cartViewModel.getCombinedPrice()
        val text = "BUY ($combinedPrice zł)"
        binding.buyButton.text = text
